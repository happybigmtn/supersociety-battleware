...
export const CrapsView = React.memo<{ gameState: GameState }>(({ gameState }) => {
    ...
    return (
        <>
            ...
            {/* EXPOSURE SIDEBAR */}
            <div className="absolute top-0 left-0 bottom-24 w-48 bg-terminal-black/80 border-r-2 border-gray-700 p-2 overflow-y-auto backdrop-blur-sm z-30 flex flex-col">
